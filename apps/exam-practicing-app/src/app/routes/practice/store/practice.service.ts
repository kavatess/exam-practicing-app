...
export class PracticeService {
    getPracticeTest(practiceId: string): Observable<PracticeExam> {
        return of({
            id: '1',
            courseId: 'abc',
            course: {
            ...
            status: PracticeExamStatuses.InProgress,
            questions: [
                {
                    id: '123',
                    practiceId: '1',
                    ...
                    state: QuestionStates.NotAnswered,
                    userAnswer: null,
                    points: 1,
                },
                {
    ...
    completePractice(
        practiceId: string,
        data: PracticeExam
    ): Observable<PracticeResult> {
        return of({
            evalTxt: 'You answered 8/10 questions correctly. Keep it up!',
            rewards: {
                gems: 10,
                energies: 5,
            },
